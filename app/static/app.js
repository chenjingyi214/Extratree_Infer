const I18N = {
  en: {
    ...
    symptoms: {
      '乏力': 'Fatigue', '低热': 'Low-grade fever', '呼吸困难': 'Dyspnea',
      '咳嗽': 'Cough', '咳痰': 'Sputum production', '喷嚏': 'Sneezing',
      '头晕/疼': 'Dizziness / headache', '憋气': 'Air hunger',
      '气短': 'Shortness of breath', '流涕': 'Rhinorrhea', '胸痛': 'Chest pain',
      '鼻塞': 'Nasal congestion', '意识模糊/嗜睡': 'Confusion / somnolence',
    },
    labs: {
      '白细胞计数': 'White blood cell count', '中性粒细胞计数': 'Neutrophil count',
      '淋巴细胞计数': 'Lymphocyte count', '单核细胞计数': 'Monocyte count',
      '血小板计数': 'Platelet count', '血小板分布宽度': 'Platelet distribution width',
      '红细胞比容': 'Hematocrit', 'C反应蛋白': 'C-reactive protein',
      '淀粉样蛋白A': 'Serum amyloid A', '肺炎支原体抗体.IgM': 'Mycoplasma pneumoniae IgM',
      '单核细胞/淋巴细胞比值': 'Monocyte/lymphocyte ratio',
      '中性粒细胞/淋巴细胞比值': 'Neutrophil/lymphocyte ratio',
      '血小板/淋巴细胞比值': 'Platelet/lymphocyte ratio',
      '系统性免疫炎症指数': 'Systemic immune-inflammation index',
      '系统性炎症反应指数': 'Systemic inflammation response index',
    },
  },
  zh: {
